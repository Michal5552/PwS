...
namespace CashWithdrawal
{
	partial class Admin_window
	{
		...
		private void InitializeComponent()
		{
			...
			// manageUsers
			// 
			this.manageUsers.Cursor = System.Windows.Forms.Cursors.Default;
			this.manageUsers.Location = new System.Drawing.Point(238, 234);
			this.manageUsers.Name = "manageUsers";
			this.manageUsers.Size = new System.Drawing.Size(105, 23);
			this.manageUsers.TabIndex = 0;
			this.manageUsers.Text = "Manage users";
			this.manageUsers.UseVisualStyleBackColor = true;
			this.manageUsers.Click += new System.EventHandler(this.button1_Click);
			// 
			// label1
			// 
			...
			// button1
			// 
			this.button1.Location = new System.Drawing.Point(438, 234);
			this.button1.Name = "button1";
			this.button1.Size = new System.Drawing.Size(96, 23);
			this.button1.TabIndex = 2;
			this.button1.Text = "Manage cash";
